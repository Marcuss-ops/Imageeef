...
// SQLiteStore implements ProjectStore for Dark Editor project persistence

// CreateProject creates a new project (ProjectStore interface)
...
// GetProject retrieves a project by ID (ProjectStore interface)
...
// UpdateProject updates an existing project (ProjectStore interface)
...
// DeleteProject deletes a project by ID (ProjectStore interface)
...
// ListProjects lists projects with optional filtering (ProjectStore interface)
...
// CreateAsset creates a new asset (ProjectStore interface)
...
// GetAsset retrieves an asset by ID (ProjectStore interface)
...
// GetAssetByFilename retrieves an asset by filename (ProjectStore interface)
...
// DeleteAsset deletes an asset by ID (ProjectStore interface)
...
// ListProjectAssets lists all assets for a project (ProjectStore interface)
...
// CreateTemplate creates a new template (ProjectStore interface)
...
// GetTemplate retrieves a template by ID (ProjectStore interface)
...
// UpdateTemplate updates an existing template (ProjectStore interface)
...
// DeleteTemplate deletes a template by ID (ProjectStore interface)
...
// ListTemplates lists templates with optional filtering (ProjectStore interface)
...
// IncrementTemplateUsage increments the usage count for a template (ProjectStore interface)
...
// CreateTempFile creates a new temp file record (ProjectStore interface)
...
// GetTempFile retrieves a temp file by filename (ProjectStore interface)
...
// DeleteTempFile deletes a temp file by filename (ProjectStore interface)
...
// CleanupExpiredTempFiles removes expired temp files (ProjectStore interface)
...
// CreateGenerationRecord creates a new generation history record (ProjectStore interface)
...
// ListGenerationHistory lists generation history with optional filtering (ProjectStore interface)
...
// initDarkEditorSchema creates tables for Dark Editor if they don't exist
